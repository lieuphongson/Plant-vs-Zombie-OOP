...
public interface ResourcesPath {
  ...
  //game basic element
  String PROJECT_DIR = new File("").getAbsolutePath(); //creates a new File object without providing a path.
  String RESOURCE_DIR = PROJECT_DIR + "/resource"; //kcombines the value of PROJECT_DIR with "/resource" to create the path to file resource
  String BACKGROUND_DAY = RESOURCE_DIR + "/background/BackgrounDay.png"; // create the path to /resource/background/BackgrounDay.png
